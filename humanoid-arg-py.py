...
parser.add_argument('--num_iterations', type=int, default=10000, help='Nombre d\'itérations')
...
parser.add_argument('--log_interval', type=int, default=2000, help='Intervalle de journalisation')
parser.add_argument('--save_interval', type=int, default=50000, help='Intervalle de sauvegarde')
parser.add_argument('--num_eval_episodes', type=int, default=100, help='Nombre d\'épisodes d\'évaluation')
parser.add_argument('--eval_interval', type=int, default=1000, help='Intervalle d\'évaluation')
...
if run_session_id is None:
    raise ValueError("run_session_id MUST BE SET")
...
try:
    ...
    raise ValueError("run_session_id ALREADY EXIST")
